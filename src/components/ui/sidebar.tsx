...
import { PanelLeft, LayoutDashboard, Settings, FileText, User } from "lucide-react"
    ...
    return (
      <main
        ...
        className={cn(
          ...
          // The spacer div in Sidebar handles the layout spacing in flex flow
...
// AppSidebar Component - Consolidated in this file
const navigation = [
  {
    title: "Dashboard",
    href: "/",
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Clay UI</span>
                  <span className="text-sidebar-foreground/70 truncate text-xs">Dashboard</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
